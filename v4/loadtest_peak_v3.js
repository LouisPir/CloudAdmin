...
// ── Flat sustained load ─────────────────────────────────────────
// Why this gives a higher number than the ramp test:
//   Your ramp test reports: total_requests / total_time = 1,704 RPS
//   But it spends 90s at low VUs (warm-up + cool-down), diluting the average.
//   This test holds 150 VUs for 2 min — the reported RPS is your real ceiling.
...
// ── Same 8 endpoints as your original test ──────────────────────
...
export function handleSummary(data) {
  const lines = [
    "\n╔══════════════════════════════════════════════════╗",
    "║       NETFLIX API — PEAK THROUGHPUT TEST         ║",
    "║          100 VUs — 2 min sustained                ║",
    "╠══════════════════════════════════════════════════╣",
  ];
  ...
  return {
    "peak_results.json": JSON.stringify(data, null, 2),
  };
}
